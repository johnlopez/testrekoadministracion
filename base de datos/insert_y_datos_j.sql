...
--
-- Servidor: localhost
-- Tiempo de generación: 18-08-2015 a las 20:46:07
...
--
-- Estructura de tabla para la tabla `institucion_has_repositorio_master`
--

CREATE TABLE IF NOT EXISTS `institucion_has_repositorio_master` (
  `institucion_id` int(11) NOT NULL,
  `repositorio_master_id` int(11) NOT NULL,
  PRIMARY KEY (`institucion_id`,`repositorio_master_id`),
  KEY `fk_institucion_has_repositorio_master_repositorio_master1_idx` (`repositorio_master_id`),
  KEY `fk_institucion_has_repositorio_master_institucion1_idx` (`institucion_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Filtros para la tabla `institucion_has_repositorio_master`
--
ALTER TABLE `institucion_has_repositorio_master`
  ADD CONSTRAINT `fk_institucion_has_repositorio_master_institucion1` FOREIGN KEY (`institucion_id`) REFERENCES `institucion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_institucion_has_repositorio_master_repositorio_master1` FOREIGN KEY (`repositorio_master_id`) REFERENCES `repositorio_master` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
