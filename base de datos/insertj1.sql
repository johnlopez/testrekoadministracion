...
--
-- Servidor: localhost
-- Tiempo de generación: 21-08-2015 a las 19:20:02
...
INSERT IGNORE INTO `dato_login` (`id`, `pregunta_secreta_1`, `pregunta_secreta_2`, `respuesta_secreta_1`, `respuesta_secreta_2`, `usuario_id`) VALUES
...
INSERT IGNORE INTO `modelo_aprendizaje_master` (`id`, `nombre`, `descripcion`, `fecha_acceso`, `fecha_modificacion`, `fecha_creacion`) VALUES
...
INSERT IGNORE INTO `repositorio_master` (`id`, `nombre`, `descripcion`, `fecha_acceso`, `fecha_modificacion`, `fecha_creacion`, `modelo_aprendizaje_master_id`, `secuencia_master_id`, `repositorio_master_id`, `tipo_repositorio_master_id`) VALUES
...
INSERT IGNORE INTO `tipo_repositorio_master` (`id`, `descripcion`) VALUES
