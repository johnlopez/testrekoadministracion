 ...
 */
class AuthitemPermisoAdministrador extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'privilegioAdministradors' => array(self::HAS_MANY, 'PrivilegioAdministrador', 'authitem_permiso_administrador_name'),
	 ...
	 * @return AuthitemPermisoAdministrador the static model class
	 */
