...
class FichaTecnicaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['FichaTecnica']))
		{
			...
			if($model->agregarFichaTecnica(
                                $model->nombre,
                                $model->descripcion    
                            ))
			
                    $this->redirect(array('view','id'=>$model->llaveIdFicha));
		}
	...
	public function actionUpdate($id)
	{
		...
		{
			$model->attributes=$_POST['FichaTecnica'];
			if($model->modificarFichaTecnica(
                                $model->id,
                                $model->nombre,
                                $model->descripcion                                
                            ))
	...
	{
		$model = new FichaTecnica();
		$listadoFichaTecnica = FichaTecnica::model()->findAll();
		$this->render('admin',array(
			'model'=>$model,
                        'listadoFichaTecnica' => $listadoFichaTecnica
		));
	}
