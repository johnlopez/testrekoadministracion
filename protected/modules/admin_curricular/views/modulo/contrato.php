...
<div class="container">
    <section>
        <table id="main_table_demo" class="display cell-hovered hovered striped" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php foreach ($listadoContrato as $contrato):?>                                                     
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/modulo/aceptacionContrato" method="get">
