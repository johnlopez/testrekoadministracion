                    ...
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/modulo/indexEntidad2" method="get">
                                    <input type="hidden" name="id" value="<?php echo $entidad['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                 ...
                                 <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/entidad/xi2" method="get">
                                    <input type="hidden" name="id" value="<?php echo $entidad['entidad_id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
