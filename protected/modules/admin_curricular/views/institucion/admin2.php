                    ...
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/institucion/listaRolesModulo" method="get">
                                    <input type="hidden" name="id" value="<?php echo $institucion['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/entidad/admin2" method="get">
                                    <input type="hidden" name="id" value="<?php echo $institucion['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/modulo/listaModulos" method="get">
                                    <input type="hidden" name="id" value="<?php echo $institucion['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                        <span class="icon mif-eye">
