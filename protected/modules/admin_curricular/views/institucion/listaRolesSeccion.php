<h2>Listado de roles por institucion</h2><br><br>
...
<div class="container">
    <section>
        <table id="main_table_demo" class="display cell-hovered hovered striped" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php foreach ($listadoRolesSeccion as $roles):?>                                                     
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_curricular/usuariohasseccion/index" method="get">
