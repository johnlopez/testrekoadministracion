...
class RepositorioController extends Controller
{
	...
	public function actionCreate()
	{
                ...
                {
                    $repositorio->attributes = $_POST['Repositorio'];
                    if($repositorio->agregarRepositorioTroncal($repositorio->nombre, $repositorio->descripcion))
                    {
                        $this->redirect(array('view','id'=>$repositorio->lastInsertRepositorioId));
                    }
                }
