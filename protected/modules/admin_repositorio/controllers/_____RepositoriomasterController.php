...
class RepositoriomasterController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array(
                                    'asignarmodeloaprendizajemaster','index','view'),
				'users'=>array('@'),
			),
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionAsignarmodeloaprendizajemaster()
	{  
            $repositorio = new RepositorioMaster();
            $modeloaprendizaje = new ModeloAprendizajeMaster();
            ...
            {                    
                ...
                {
                    $repositorio->asignarModeloAprendizajeMasterRepositorioMaster($_GET['id'], $_POST['ModeloAprendizajeMaster']['id']);
                ...
                {                    
                    ...
                    $this->render('asignarmodeloaprendizajemaster', array('vmodeloaprendizaje'=>$vmodeloaprendizaje,'modeloaprendizaje'=>$modeloaprendizaje,'vrepositorio'=>$vrepositorio));                    
                }
            }                
	}
}
