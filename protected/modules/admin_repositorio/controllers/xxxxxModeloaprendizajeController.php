...
class ModeloaprendizajeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['modeloAprendizajeNombre']))
		{
                                       
                    echo $_POST['modeloAprendizajeNombre']."<br>"; 
                    echo $_POST['modeloAprendizajeDescripcion']."<br>"; 
                    echo $_POST['trabajoGrupalCheck']."<br>";
//                    $suma = $_POST['trabajoGrupalCheck'];
//                    $s = $suma + $suma;
//                    echo "//////".$s."/////";
                    echo $_POST['archivoRecursoCheck']."<br>";
//                    echo $_POST['linkInteresCheck']."<br>";
                    echo $_POST['glosarioCheck']."<br>";
                    echo $_POST['contenidoLibreCheck']."<br>";
//                    echo $_POST['foroCheck']."<br>";
                    echo $_POST['evaluacionCheck']."<br>";
                    echo $_POST['autoevaluacionCheck']."<br>";
//                    echo $_POST['proyectoCheck']."<br>";
                    echo $_POST['recepcionTrabajoCheck']."<br>";
                    echo $_POST['evaluacionNoObjetivaCheck']."<br>";		
