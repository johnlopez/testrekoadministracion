...
<div class="place-right padding20 no-padding-top no-padding-right">
        <form class="place-left padding20 no-padding-left no-padding-bottom no-padding-top" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/institucionhasrolusuario/listainstitucion" >
            <button class="button primary" type="submit">
                    Asignar Rol Usuario a Institucion
            </button>
        </form> 
        <form class="place-left padding20 no-padding-left no-padding-bottom no-padding-top" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/rolusuario/index" >
            <button class="button primary" type="submit">
                    Listar Rol Usuario General
            </button>
        </form>    
        <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/rolusuario/create" >
            <button class="button primary" type="submit">
                    Crear Rol Usuario General
            </button>
        </form>          
</div>

<h1>Rol Usuario General</h1>
                    ...
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/rolusuario/update" method="get">
                                    <input type="hidden" name="id" value="<?php echo $m['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/rolusuario/delete" method="post">
                                    <input type="hidden" name="id" value="<?php echo $m['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
