                    ...
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_rol_usuario/usuariohasrolusuario/asignarusuariorolusuario" method="get">
                                    <input type="hidden" name="id" value="<?php echo $m['id']?>" />
                                    <input type="hidden" name="rolUsuarioNombre" value="<?php echo $m['nombre']?>" />
                                    <input type="hidden" name="institucionId" value="<?php echo $institucionId;?>" />
                                    <input type="hidden" name="institucionNombre" value="<?php echo $institucionNombre;?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
                                        Asignar Usuarios
                                    </button>
                                </form>
