                    ...
                    <tr>
                        ...
                        <td>                                        
                            ...
                            <div id="button-group-1">
                                ...
                                <form class="place-left" action="<?php echo Yii::app()->getBaseUrl(); ?>/admin_usuario/datoacademico/admin" method="post">
                                    <input type="hidden" name="idUsuarios" value="<?php echo $usuario['id']?>" />
                                    <button class="toolbar-button bg-white bg-active-grayLighter fg-black" type="submit">
