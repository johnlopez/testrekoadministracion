...
class DatoLoginController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('DatoLogin');
	 ...
	 * @return DatoLogin the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=DatoLogin::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DatoLogin $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dato-login-form')
		{
