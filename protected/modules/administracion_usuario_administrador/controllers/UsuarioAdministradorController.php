...
//                echo "Se creo un Rol";
	...
	{               
                Yii::import('application.modules.administracion_rol_administrador..models.RolAdministrador');
        ...
        public function actionAssign($id)
        {
            ...
            if(UsuarioAdministrador::model()->checkUsuarioRol($id,$_GET["nombre_rol"]))
            {
                $usuario->desasignarRolUsuario($id,$_GET["nombre_rol"]);
            }
            else
            {
                $usuario->asignarRolUsuario($id,$_GET["nombre_rol"]);                
            }
